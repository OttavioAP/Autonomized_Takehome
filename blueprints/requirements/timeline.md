...
| 4 | Deploy hello world to Microsoft Azure | Prove the deployment path end-to-end with a trivial app before any real feature work, so infra problems surface early. | N/A | ⬜ | ⬜ | ⬜ | N/A |
